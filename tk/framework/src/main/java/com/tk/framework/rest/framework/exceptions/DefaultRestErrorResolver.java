 ...
 * 
 *  Notes:
 *  $Id: DefaultRestErrorResolver.java  2014-12-24 23:59:59Z \TK $ 
 * 
 * @Revision History:
 * <<2014年12月25日下午3:24:59>>, <<Who>>, <<what>>  
...
public class DefaultRestErrorResolver implements RestErrorResolver, MessageSourceAware, InitializingBean
{
	...
	/**
	 * Returns the response status message to return to the client, or {@code null} if no status message should be
	 * returned.
	 *
	 * @return the response status message to return to the client, or {@code null} if no status message should be
	 *         returned.
	 */
	...
	/**
	 * Returns the config-time 'template' RestError instance configured for the specified Exception, or {@code null} if
