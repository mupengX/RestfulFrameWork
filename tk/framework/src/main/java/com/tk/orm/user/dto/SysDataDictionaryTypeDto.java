 ...
 * <pre>
 *  
 *  File: SysDataDictionaryTypeDto.java
 *  , Inc.
 *  Copyright (C): 2015
 *  Description:
 *  数据字典类型DTO
 * 
 *  Notes:
 *  $Id: SysDataDictionaryTypeDto.java  2014-12-24 23:59:59Z \TK $ 
 * 
 * @Revision History:
 * <<2015年3月12日下午5:39:55>>, <<Who>>, <<what>>  
 *  2015年3月12日		TK		Initial.
 * </pre>
 */
public class SysDataDictionaryTypeDto extends BaseDto
{

	/**
	 * Comment for &lt;code&gt;serialVersionUID&lt;/code&gt;
	 */
	private static final long serialVersionUID = -4065064843115509778L;
	...
	/**
	 * SysDataDictionaryTypeDto Constructor.
	 * 
	 */
	public SysDataDictionaryTypeDto()
	{
		super();
	}
	 ...
	 * 
	 */
	public SysDataDictionaryTypeDto(SysDataDictionaryTypePo po)
	{
		super();
	 ...
	 * @return
	 */
	public SysDataDictionaryTypePo SysDataDictionaryTypeDto2Po(SysDataDictionaryTypeDto dto)
	{
		SysDataDictionaryTypePo po = new SysDataDictionaryTypePo();
